...
import weddellseal.markrecap.PermissionManager.Companion.REQUIRED_PERMISSIONS_POST_T
import weddellseal.markrecap.PermissionManager.Companion.REQUIRED_PERMISSIONS_PRE_T
    ...
    Scaffold(
        ...
        Column(
            ...
            if (state.value.hasAllAccess) {
                FilledTonalButton(onClick = { navController.navigate(Screens.HomeScreen.route) }) {
                    Text("Get started")
                }
            } else {
