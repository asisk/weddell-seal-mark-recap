...
//        val loc = locationManager.getLastKnownLocation(LocationManager.GPS_PROVIDER) as Location
//        val lastKnownLocation = loc.longitude.toString().plus(", ").plus(loc.latitude.toString())
//        uiState = uiState.copy(lastKnownLocation = lastKnownLocation)
//    }
